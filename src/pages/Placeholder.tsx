  ...
  return (
    <main class="placeholder-page">
      ...
      <section class="placeholder-card">
        ...
        <h1>{title()}</h1>
        <p>This section is wired through Solid Router and ready for content. The first public milestone is the homepage.</p>
